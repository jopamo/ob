...
typedef enum { RR_RELIEF_FLAT, RR_RELIEF_RAISED, RR_RELIEF_SUNKEN, RR_RELIEF_NUM_TYPES } RrReliefType;

typedef enum { RR_BEVEL_1, RR_BEVEL_2, RR_BEVEL_NUM_TYPES } RrBevelType;
...
typedef enum { RR_JUSTIFY_LEFT, RR_JUSTIFY_CENTER, RR_JUSTIFY_RIGHT, RR_JUSTIFY_NUM_TYPES } RrJustify;
...
typedef enum { RR_FONTSLANT_NORMAL, RR_FONTSLANT_ITALIC, RR_FONTSLANT_OBLIQUE, RR_FONTSLANT_NUM_TYPES } RrFontSlant;
...
/*! Returns an RrSize, that was allocated with g_slice_new().  Use g_slice_free() to
  free it. */
RrSize *RrFontMeasureString( const RrFont *f, const gchar *str, gint shadow_offset_x, gint shadow_offset_y,
