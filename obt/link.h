...
typedef enum { OBT_LINK_TYPE_APPLICATION = 1, OBT_LINK_TYPE_URL = 2, OBT_LINK_TYPE_DIRECTORY = 3 } ObtLinkType;
...
ObtLink* obt_link_from_ddfile(const gchar* name, GSList* paths, struct _ObtPaths* p);
