...
gboolean obt_xml_load_mem(ObtXmlInst* inst, gpointer data, guint len, const gchar* root_node);
...
void obt_xml_register(ObtXmlInst* inst, const gchar* tag, ObtXmlCallback func, gpointer data);
