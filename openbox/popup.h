...
void icon_popup_delay_show(ObIconPopup* self, gulong msec, gchar* text, RrImage* icon);
...
#define icon_popup_text_width_to_string(p, s) popup_text_width_to_string((p)->popup, (s))
#define icon_popup_text_width_to_strings(p, s, n) popup_text_width_to_strings((p)->popup, (s), (n))
...
#define pager_popup_text_width_to_string(p, s) popup_text_width_to_string((p)->popup, (s))
#define pager_popup_text_width_to_strings(p, s, n) popup_text_width_to_strings((p)->popup, (s), (n))
