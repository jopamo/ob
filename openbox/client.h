 ...
 */
void client_convert_gravity_resize( ObClient *self, gint gravity, gint *x, gint *y, gint w, gint h );

#define client_move( self, x, y ) client_configure( self, x, y, self->area.width, self->area.height, TRUE, TRUE, FALSE )
#define client_resize( self, w, h ) client_configure( self, self->area.x, self->area.y, w, h, TRUE, TRUE, FALSE )
...
#define client_reconfigure( self, force )                                             \
  client_configure( self, ( (ObClient *)self )->area.x, ( (ObClient *)self )->area.y, \
                    ( (ObClient *)self )->area.width, ( (ObClient *)self )->area.height, FALSE, TRUE, force )
...
*/
void client_try_configure( ObClient *self, gint *x, gint *y, gint *w, gint *h, gint *logicalw, gint *logicalh,
                           gboolean user );
...
*/
void client_configure( ObClient *self, gint x, gint y, gint w, gint h, gboolean user, gboolean final,
...
/*! dir is either North, South, East or West. It can't be, for example,
  Northwest */
void client_find_edge_directional( ObClient *self, ObDirection dir, gint my_head, gint my_tail, gint my_edge_start,
...
void client_find_resize_directional( ObClient *self, ObDirection side, ObClientDirectionalResizeType resize_type,
...
*/
void client_activate( ObClient *self, gboolean desktop, gboolean here, gboolean raise, gboolean unshade,
                      gboolean user );
